...
# Create matter aggregates for PFM ####
M <-c("", 
...
# Create energy aggregates for PFM ####
E <-c("", 
      "",
      "",
...
# Create matter aggregates for PSFM ####
...
# Create energy aggregates for PSFM
...
# Create co2 aggregates for PSFM
...
# Create s.e.s. aggregates for PSFM
...
# Create captions
caption3 <- paste("Table 4. Physical flow matrix of Model ECO-3IO-PC in period", yr, "under baseline (matter = Gt, energy = EJ)")
caption4 <- paste("Table 5. Physical stock-flow matrix matrix of Model ECO-3IO-PC in period ",yr, "under baseline (matter = Gt, energy = EJ)")
